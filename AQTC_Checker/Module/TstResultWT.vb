				...
				Then
					...
					With MESrec.dt(i).t3
						...
						If .dsiz > 0 Then
							...
							'			+ ",判定基準１,判定１,判定基準２,判定２"
							Buff = "温度CH1,,,温度CH2,,,印加電圧CH1,,印加電圧CH2,,ＭＦＣ電圧1Kpa,,リーク量1Kpa,,ＭＦＣ電圧2Kpa,,リーク量2Kpa,,ＭＦＣ電圧3Kpa,,リーク量3Kpa,,ＭＦＣ電圧4Kpa,,リーク量4Kpa,,ＭＦＣ電圧6Kpa,,リーク量6Kpa,,判定基準１,判定１,判定基準２,判定２"
							'▲ 2024.06.11 TC Kanda （その他．ログファイルのタイトル位置修正）
					...
					With MESrec.dt(i).t2
						...
						For j = 0 To .dsiz - 1
							...
							Buff +=
								"," +
								.d(j).he.ToString("0.00") +
								",sccm"

							Buff +=
								"," +
								.d(j).tmr(0).ToString("0.") +
								",sec"

							Buff +=
								"," +
								.d(j).tmr(1).ToString("0.") +
								",sec"

							Buff +=
								"," +
								.d(j).tmr(2).ToString("0.") +
								",sec"

							Buff +=
								"," +
								.d(j).tmr(3).ToString("0.") +
								",sec"

							Buff +=
								"," +
								.d(j).tmr(4).ToString("0.") +
								",sec"
