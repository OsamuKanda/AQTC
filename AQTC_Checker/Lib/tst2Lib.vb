...
'	)	As Integer
		...
		Do While ( 3 > nrty )
			...
			'
			'▼ 2024.04.19 TC Kanda （１．配管真空排気シーケンス修正/ウエハ吸着直測定においてESC電源ONは既にありました）
			...
			'	吸着を停止する
			'
			'▼2024.04.19 TC Kanda （１．配管真空排気シーケンス修正／ESC電源OFFの処理を チャンバ内圧力を下げる前に異動）
			'ESCstop( 2000.0, 7 )
			'▲2024.04.19 TC Kanda （１．配管真空排気シーケンス修正／ESC電源OFFの処理を チャンバ内圧力を下げる前に異動）
			...
			'	ウエハ裏面圧条件待ち処理
			'
			'▼2024.04.11 TC Kanda （１．配管真空排気シーケンス修正／無限ループすることがあるらしいので削除）
